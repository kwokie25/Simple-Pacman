...
public class ItemProcess {
    ...
    public ItemProcess(String file) {
        ...
        try {
            ...
            InputStream template = classloader.getResourceAsStream(fileName);
            BufferedReader bTemplate = new BufferedReader( new InputStreamReader( template, "UTF-8" ) );
    ...
    public ItemProcess(String file, GameDisplay gd) {
        ...
        try {
            ...
            ClassLoader classloader = Thread.currentThread().getContextClassLoader();
            InputStream template = classloader.getResourceAsStream(file);
            BufferedReader bTemplate = new BufferedReader( new InputStreamReader( template, "UTF-8" ) );
